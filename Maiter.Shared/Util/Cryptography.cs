...
namespace Maiter.Shared.Util
{
    public static class Cryptography
    {
        ...
        public static string Encrypt(byte [] valueBytes, string password)
        {
        ...
        public static string Encrypt<T>(byte [] valueBytes, string password)
                ...
                where T : SymmetricAlgorithm, new()
        {
            ...
            return Encrypt<T>(valueBytes, password);            
        }

        public static string Decrypt(byte [] valueBytes, string password)
        {
        ...
        public static string Decrypt<T>(string value, string password) where T : SymmetricAlgorithm, new()
        {
            ...
            return Decrypt<T>(valueBytes, password);
        }
